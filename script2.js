...
var m = {
    augiA20Il: {
      elements: {},
      page: d(() =>
        import("./k6fpj3n1QpvAJrbizzLbyIp0jt8BZjhUj8EW2ppKnb8.GZERTYCC.mjs")
      ),
      path: "/",
    },
    L55yTZkrn: {
      elements: {},
      page: d(() =>
        import("./aDNO04UeWyn7sF6q_XW4LJZHSoMBIj44KhtIh_eiwFU.EEM6IXCQ.mjs")
      ),
      path: "/about-us",
    },
    howAnR9Z3: {
      elements: {},
      page: d(() =>
        import("./U02FH-37fpBP_0U3Msa6KdLi3Z4toUgDz4xziKfZYa4.NWWLYC7Z.mjs")
      ),
      path: "/portfolio",
    },
    Aok_VFa6C: {
      elements: {},
      page: d(() =>
        import("./a9PUNNJ9nK5BmvTj7MrApUcyRKYGLqUuFv1nyOIc5dA.EBXTWUHK.mjs")
      ),
      path: "/quote",
    },
  },
...
if (k) {
  (e.__framer_importFromPackage = (l, u) => () =>
    c(j, {
      error: 'Package component not supported: "' + u + '" in "' + l + '"',
    })),
    (e.process = {
      ...e.process,
      env: { ...(e.process ? e.process.env : void 0), NODE_ENV: "production" },
    }),
    ...
    typeof e < "u" &&
      (async () => {
        ...
        if (a?.collectionId && I) {
          ...
          i &&
            typeof P == "string" &&
            (w = (await i.getRecordIdBySlug(P, R || void 0)) ?? null);
        }
...
//# sourceMappingURL=script_main.7HDHZ7ZW.mjs.map
